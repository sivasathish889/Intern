...
// table creation
db.query('CREATE TABLE IF NOT EXISTS admin (id int primary key auto_increment, name varchar(100),email varchar(100), password varchar(100),creditional_id varchar(100), public_Key varchar(1000), counter int, deviceType varchar(100), backup varchar(100), transport varchar(100) );')
